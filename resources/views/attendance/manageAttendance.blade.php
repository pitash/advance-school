...
<style type="text/css">
        ...
        <div class="col-12">
          <!-- @@@@@@@@@@ Start Messages @@@@@@@@@@@@ -->
           ...
           <?php
                ...
                $sections=DB::table('academic_sections')->get();

            ?>
          <div class="box">
            <div class="box-header">
            	 <div class="col-md-12" style=" padding-bottom: 50px;">
            	<a href="{{URL::to('create-student-attendance')}}" class="btn btn-md btn-success"><i class="fa fa-plus"></i> Add a Student Attendance</a>
            </div>
 ...
 <!--                     <div class="form-group">
                  ...
                  <li class="col-md-2">
                    <button onclick="get_att();" class="btn btn-info btn-block">Attendance View</button>
                  </li>
                </ul>
