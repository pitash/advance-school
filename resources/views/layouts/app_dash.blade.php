      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item fa fa-retweet" href="buttons.html">&nbsp Create Attendance</a>
            <a class="collapse-item fa fa-sort" href="cards.html">&nbsp Show Attendance</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item fa fa-sitemap" href="login.html">&nbsp Group</a>
            <a class="collapse-item fa fa-street-view" href="login.html">&nbsp Class</a>
            <a class="collapse-item fa fa-tag" href="register.html">&nbsp Section</a>
            <a class="collapse-item fa fa-random" href="forgot-password.html">&nbsp Subject</a>
          </div>
        </div>
      </li>
     <hr class="sidebar-divider">
      ...
      <li class="nav-item active">
        {{-- <a class="nav-link" href="{{ route('/gurdian.index') }}"> --}}
          <i class="fas fa-circle-notch fa-spin"></i>
          <span>Add Gurdian</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="utilities-color.html">General Setting's</a>
            <a class="collapse-item" href="utilities-color.html">Language Setting's</a>
            <a class="collapse-item" href="utilities-color.html">Backup Database</a>
          </div>
        </div>
      </li>
